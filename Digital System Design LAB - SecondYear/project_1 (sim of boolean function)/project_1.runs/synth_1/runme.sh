...
HD_PWD='C:/Users/KIIT0001/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pos_circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pos_circuit.tcl
