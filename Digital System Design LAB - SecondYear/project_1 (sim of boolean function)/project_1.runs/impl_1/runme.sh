...
HD_PWD='C:/Users/KIIT0001/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pos_circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pos_circuit.tcl -notrace
